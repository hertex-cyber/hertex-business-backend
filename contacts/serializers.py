    ...
    def get_pipelines(self, obj):
        ...
        for deal in crm_deals:
            results.append({
                ...
                'pipeline_name': deal.pipeline.name if deal.pipeline else 'Unknown Pipeline',
...
class ContactLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ContactLog
        fields = [
            'id', 'contact', 'crm', 'user', 'user_details',
            'activity_type', 'description', 'created_at', 'updated_at'
        ]
...
class ContactDocumentSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            'id', 'contact', 'document_type', 'file', 'file_name',
