...
- Stage management (add, reorder, rename, delete via ManageStageModal)
- Assignment management (view stats, trigger re-assignment)
- User-pipeline access management (via UserPipelineManager)
- Pipeline settings (type, mandatory fields, custom fields)
